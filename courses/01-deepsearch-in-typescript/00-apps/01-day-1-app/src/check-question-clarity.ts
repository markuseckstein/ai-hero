...
import { clarificationModel } from "./model";

const CLARITY_CHECK_SYSTEM_PROMPT = `You are a clarification assessment agent for a DeepSearch system. Your job is to determine whether a user's question requires clarification before conducting a comprehensive search and response.
...
export const checkIfQuestionNeedsClarification = async (
  ...
  const { object } = await generateObject({
    ...
    system: CLARITY_CHECK_SYSTEM_PROMPT,
